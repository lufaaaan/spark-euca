...
def setup_cluster(conn, master_nodes, slave_nodes, opts, deploy_ssh_key):
  ...
  ssh(master, opts, "echo JAVA_HOME='/usr/java/jdk1.8.0_25'  >> /etc/environment")
  ssh(master, opts, "echo SCALA_HOME='/root/scala' >> /etc/environment")
  ssh(master, opts, "echo PATH='/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/root/scala/bin:/usr/java/jdk1.8.0_25/bin' >> /etc/environment")
